  ...
  <div id="centerLeft1">
    <div class="bg-color-black">
      <div class="d-flex pt-2 pl-2">
        ...
        <div class="d-flex">
          <span class="fs-xl text mx-2">任务数量TOP6</span>
          <!-- <dv-decoration-3 class="dv-dec-3" :color="['#999', '#fff']" /> -->
        </div>
      </div>
      <div class="d-flex jc-center chart">
        <Chart :cdata="config" />
      </div>
    </div>
  </div>
...
<script>
// import CenterLeft3Chart from '@/components/echart/pie'
